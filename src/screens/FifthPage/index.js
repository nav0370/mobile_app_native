        ...
        <View style={styles.container}>
           ...
           <View style={styles.top}>
            ...
            >
              <Icon size={30} name="ios-arrow-back-sharp" />
                        ...
                        <Text style={styles.jyc}>Congratulations</Text>

                        <Text style={styles.access}> You have successfully registered !</Text> 
           ...
           <View style={styles.inmid}>
            ...
            <AppTextInput
             ...
             <Text style={styles.otpsent}>(OTP sent on your email & phone)</Text>
           ...
           <View style={styles.bottom}>
                       ...
                       <LinearGradient    start={{ x: 0.0, y: 0.25 }}
                                        ...
                                        >
                               <TouchableOpacity style={styles.emailbtn}     onPress={() => NavigationService.navigate("FamilyScreen")} >
              ...
              <View style={styles.loginhere}>
                 ...
                 <Text style={styles.aj}>You didn't recieve an OTP? </Text>
                 <TouchableOpacity><Text style={styles.login}>Resend OTP</Text></TouchableOpacity>
