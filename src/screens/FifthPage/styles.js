...
jyc:{fontSize: 22,fontFamily: theme.font.fontSemiBold,color:'#fc8019',
...
mid:{height:120,width:Dimensions.get('window').width,justifyContent:'center',alignItems:'center',

},

inmid:{height:100,width:Dimensions.get('screen').width-50,flexDirection: 'column',justifyContent:'space-evenly',
...
login:{
fontSize: 14,fontFamily: theme.font.fontRegular,color:'#fc8019',
