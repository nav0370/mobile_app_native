...
access:{
fontSize: 22,fontFamily: theme.font.fontSemiBold,
color:'#fc8019',
},
...
mid:{height:170,width:Dimensions.get('screen').width,justifyContent:'center',alignItems:'center',

},

inmid:{height:170,width:Dimensions.get('screen').width-50,justifyContent:'center'
...
email:{
  fontSize: 17,fontFamily: theme.font.fontSemiBold,color:'white',letterSpacing:0,
},
