...
mid:{height:140,width:Dimensions.get('screen').width,justifyContent:'center',alignItems:'center',

},

inmid:{height:140,width:Dimensions.get('screen').width-50,justifyContent:'center'
