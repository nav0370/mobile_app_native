...
mid:{height:300,width:Dimensions.get('window').width,justifyContent:'center',alignItems:'center',marginTop: 0,

},

inmid:{height:300,width:Dimensions.get('screen').width-50,flexDirection: 'column',justifyContent:'space-evenly',
...
bottom:{
  height:90,width:Dimensions.get('screen').width,alignItems:'center',marginTop:0,
},
