            ...
            >
              ...
              <View style={{ paddingBottom: 28 }}>
                ...
                <AppTextInput
                  icon="email-outline"
                  label="Job Schedule"
                  placeholder="Enter your job Schedule"
                  onChangeText={handleChange("email")}
                  onBlur={handleBlur("email")}
                  error={errors.email}
                  touched={touched.email}
              ...
              <View style={{ paddingBottom: 28 }}>
                ...
                <AppTextInput
                  icon="email-outline"
                  label="Hiring End Date"
                  placeholder="Enter your hiring End Date"
                  onChangeText={handleChange("email")}
                  onBlur={handleBlur("email")}
                  error={errors.email}
                  touched={touched.email}
              ...
              <View style={{ paddingBottom: 50 }}>
                ...
                <AppTextInput
                  ...
                  returnKeyType="next"
                  returnKeyLabel="next"
                  styles={{ height: 40, marginBottom: 20 }}
                  onSubmitEditing={() => passwordRef.current?.focus()}
                />
                <AppTextInput
                  icon="email-outline"
                  label="per month"
                  placeholder="Enter your How many hires do you want?"
                  onChangeText={handleChange("email")}
                  onBlur={handleBlur("email")}
                  error={errors.email}
                  touched={touched.email}
